...
const isAccountsPage = computed(() => route.name === 'accounts');
...
const navigateToDeploymentServers = () => {
  router.push({ name: 'deployment-servers' });
};
      ...
      <div class="logo-section">
        <div class="logo">
          <div class="logo-content" @click="router.push({ name: 'Dashboard' })">
            <div class="title">
              <span>Kartbayairfivefivefive</span>
            </div>
            <div class="subtitle">
